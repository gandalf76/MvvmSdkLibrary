...
object MockUtils {
    ...
    const val FONT_SPRITE = "front sprite"
    ...
    fun getPokemonNoTranslation(): Pokemon {
        val language = Language(LANGUAGE_NAME, LANGUAGE_URL)
        val version = Version(VERSION_NAME, VERSION_URL)
        return Pokemon(1, POKE_NAME, listOf())
    }
    fun getSprites(): Sprites = Sprites(Sprite(BACK_SPRITE, FONT_SPRITE))
